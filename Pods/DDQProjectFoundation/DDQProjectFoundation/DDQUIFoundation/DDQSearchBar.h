...
@optional
- (void)searchBar_beginEditingWithSearchBar:(DDQSearchBar *)bar;
- (void)searchBar_endEditingWithSearchBar:(DDQSearchBar *)bar;
- (void)searchBar_text:(nullable NSString *)text relpaceText:(nullable NSString *)rText range:(NSRange)range searchBar:(DDQSearchBar *)bar;
