...
@property (nonatomic, copy) DDQTableViewDidDeSelectConfig deselectConfig;
...
- (void)tableView_setDidDeselectConfig:(DDQTableViewDidDeSelectConfig)config {
    
    if (config) self.deselectConfig = config;
...
- (void)tableView:(UITableView *)tableView didDeselectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.deselectConfig) self.deselectConfig(indexPath);
